...
A stochastic process ${M(t)}_{t\ge 0}$ is called a martingale with respect to the filtration ${{F}_t}_{t\ge 0}$ if it is adapted to ${{F}_t}_{t\ge 0}$, $M(t)\in L^1(\Omega)$ for all $t\ge 0$, and
