...
To illustrate the method in a finance-oriented setting, we consider synthetic returns generated by a two-regime Hidden Markov Model (see also [HHM section](https://github.com/cifanip/quantitative-finance/tree/main/cases/04_hidden_markov_models/)), designed to mimic alternating calm and turbulent market conditions. This provides a controlled setting in which to examine how persistent homology captures structural changes in the data.
