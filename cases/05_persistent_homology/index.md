...
To illustrate the method in a finance-oriented setting, we consider synthetic returns generated by a two-regime Hidden Markov Model (see also [HHM section](https://cifanip.github.io/quantitative-finance/cases/04_hidden_markov_models/)), designed to mimic alternating calm and turbulent market conditions. This provides a controlled setting in which to examine how persistent homology captures structural changes in the data. 
