module fft_r2c_1d
  ...
  type, extends(fft_type), public :: fft_r2c_1d_type
    private
...
!========================================================================================!
  subroutine delete(this)
    class(fft_r2c_1d_type), intent(inout) :: this
...
!========================================================================================!
  subroutine ctor(this,size)
    class(fft_r2c_1d_type), intent(out) :: this
    integer :: size
...
!========================================================================================!
  subroutine build_plan(this)
    ...
    this%plan(1)=fftw_plan_dft_r2c_1d(n,this%in,this%out,fftw_estimate)
...
!========================================================================================!
  subroutine execute_plan(this)
    ...
    call dfftw_execute_dft_r2c(this%plan(1),this%in,this%out)
...
!========================================================================================!
  subroutine get_input(this,x)
    class(fft_r2c_1d_type), intent(in) :: this
